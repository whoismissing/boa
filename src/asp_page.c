...
{"interfaceList", interfaceList},
	...
	{"PimdRpList", PimdRpList},
	{"PimdInterfaceList", PimdInterfaceList},
#endif
#ifdef CONFIG_APP_MROUTED
	{"mroutedIfList", mroutedIfList},
	{"mroutedTunnelList", mroutedTunnelList},
	{"mroutedAltnetList", mroutedAltnetList},
#endif
	...
	{"getQosWanPort",getQosWanPort},
	{"getQoSWan",getQoSWan},
	{"getWanPortEnable",getWanPortEnable},
#endif
	{"getQosQueue", getQosQueue},
	{"getQosClass", getQosClass},
	{"getQosType", getQosType},
	{"getQosUpCar", getQosUpCar},

#elif defined(MULTI_WAN_QOS)
	{"getQoSWanTraffic",getQoSWanTraffic},
	{"getQoSWanPolicy",getQoSWanPolicy},
	{"qosTrafficList", qosTrafficList},
	{"qosPolicyList", qosPolicyList},
	{"qosRuleList", qosRuleList},
	...
	{"FilteredSysLogList", FilteredSysLogList},
	{"sysCmdLog", sysCmdLog},
	...
	{"vlanBindingList", vlanBindingList},
	{"showLanDeviceList", showLanDeviceList},
#endif
#ifdef CONFIG_CMCC
#ifdef MULTI_WAN_SUPPORT
	{"wanListForPortMapping",wanListForPortMapping},
#endif
#endif
	...
	{"wanListForAWiFi", wanListForAWiFi},
	{"aWiFiTrustedMacList", aWiFiTrustedMacList},
	{"aWiFiTrustedUrlList", aWiFiTrustedUrlList},
#endif
...
form_name_t root_form[] = {
...
#ifdef CONFIG_CMCC
	{"formEthernet_cmcc", formEthernet_cmcc},
	{"formFastConf",formFastConf},
	{"formTracert",formTracert},
	{"formPing",formPing},
	{"formL2tpCfg",formL2tpCfg},
#endif
#if 0
	{"formWep64", formWep64},
	...
	{"formSuperPasswordSetup", formSuperPasswordSetup},
#endif
...
#ifdef CONFIG_APP_MROUTED
	{"formmroutedroute", formmroutedroute},
#endif
#ifdef CONFIG_APP_PIMD
	{"formpimdroute", formpimdroute},
#endif
#ifdef CONFIG_CMCC
#ifdef RTL_NF_ALG_CTL
	{"formALGOnOff", formALGOnOff},
#endif
	{"formIgmpMldSnoopingProxy",formIgmpMldSnoopingProxy},
	{"formUpnp", formUpnp},
#endif
...
#if defined(CONFIG_CMCC_QOS)
#if defined(CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT)
	{"formMultiPhyWanUplinkQoS",formMultiPhyWanUplinkQoS},
	{"formMultiPhyWan",formMultiPhyWan},
	{"formUplinkMultiPhyWanQosRule",formUplinkMultiPhyWanQosRule},
#else
	{"formUplinkQoS", formUplinkQoS},
	{"formUplinkQosRule", formUplinkQosRule},
#endif	
	{"formShapingQoS", formShapingQoS},
#elif defined(MULTI_WAN_QOS)
	{"formQosTraffic", formQosTraffic},
	{"formQosPolicy", formQosPolicy},
	{"formQosRule", formQosRule},
#elif defined(GW_QOS_ENGINE)
	{"formQoS", formQoS},
#elif defined(QOS_BY_BANDWIDTH)
	{"formIpQoS", formIpQoS},
...
//	{"formSysCmd", formSysCmd},
	...
	{"formSetSyslogDisplayLevel", formSetSyslogDisplayLevel},
	{"formSaveClrSysLog", formSaveClrSysLog},
#ifdef SYS_DIAGNOSTIC
	{"formDiagnostic", formDiagnostic},
#endif
	{"formTr069Diagnose", formTr069Diagnose},
...
#endif
    {"formCluMgmt", formCluMgmt},
#if defined(CONFIG_MULTIPLE_WAN_VLAN_BINDING)
	{"formVlanBinding", formVlanBinding},
#endif
#if defined(CONFIG_ELINK_SUPPORT)
	{"formElink",formElink},
#if defined(CONFIG_ELINKSDK_SUPPORT)
	{"formElinkSDKUpload",formElinkSDKUpload},
#endif
#endif

#ifdef CONFIG_APP_AWIFI_SUPPORT
	{"formAWiFi", formAWiFi},
	{"formAWiFiMacList", formAWiFiMacList},
	{"formAWiFiUrlList", formAWiFiUrlList},
#ifdef	CONFIG_APP_AWIFI_AUDIT_SUPPORT
	{"formAWifiAudit", formAWifiAudit},
#endif
#endif
...
//	mac[0]='11';
	//printf("%s:%d buf=%s mac=%s len=%d\n",__FUNCTION__,__LINE__,buf,mac, strlen(buf));
...
#ifdef CONFIG_CMCC
	if(strcmp(form,"formPing") == 0)		return;
	if(strcmp(form,"formTracert") == 0)		return;
#endif	
