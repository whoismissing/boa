...
#ifdef MIB_TLV
/*Means Normal MIB ID should less than 16383*/
#define MIB_TABLE_LIST 0x8000
#else
#define MIB_TABLE_LIST 0x0
#endif
#define NTP_SERVER_NUM 6 // no more than 6

//#define TLV_LENGTH_INT
#ifdef TLV_LENGTH_INT
#define MIBTBL_WLAN_TLV_INT 0x4000
#endif
//#ifdef HOME_GATEWAY
...
#ifdef TLV_LENGTH_INT
#define MIB_WLAN_ROOT	(101|MIB_TABLE_LIST|MIBTBL_WLAN_TLV_INT)
#else
...
#define MIB_LIMIT_USER_ENABLE 11000
#define MIB_LIMIT_USER_NUM 11001
#endif
...
#define NTP_TIME_DIFFERENCE_FILE	"/var/run/ntp.diff"
...
#define SYSLOG_CONF_FILENAME	"/var/cwmp_config/syslog.conf"
...
#define MIB_DDNS_PORT    		4191

#endif
#define MIB_OP_MODE			192
#define MIB_WISP_WAN_ID			193
#define MIB_REPEATER_MODE	196
...
#define MIB_CUSTOMER_HW_ELINK_SERIAL_NUM CUSTOMER_HW_MIB_BaseId+2
...
#ifdef HOME_GATEWAY
#ifdef DOS_SUPPORT
#define MIB_DOS_FIREWALL_LEVEL		10530
...
#define MIB_IPFILTER_MODE       257    

#ifdef MACFILTER_MODE_SUPPORT
#define MIB_MACFILTER_MODE			258
#endif
...
#define VLANBINDING_PAIR_LENGTH			10
#define MIB_VLANBINDING_ENABLED			344
#define MIB_VLANBINDING_TBL_NUM			345
#define MIB_VLANBINDING_HWNAT_LANVID	346
#define MIB_VLANBINDING_TYPE			347
#define MIB_VLANBINDING_VLAN			348
#define MIB_VLANBINDING_INTFIDX			349
#define MIB_VLANBINDING_TBL			((MIB_VLANBINDING_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_VLANBINDING_ADD			((MIB_VLANBINDING_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_VLANBINDING_DEL			((MIB_VLANBINDING_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_VLANBINDING_DELALL		((MIB_VLANBINDING_TBL_NUM+4)| MIB_DELALL_TBL_ENTRY)
#define MIB_VLANBINDING_MOD         ((MIB_VLANBINDING_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#endif
...
#ifdef DOS_SUPPORT
#define MIB_IPV6_DOS_ENABLE 			(MIB_IPV6_ID+38)
#define MIB_IPV6_DOS_SMURF_FLOOD (MIB_IPV6_ID+39)
#define MIB_IPV6_DOS_ICMP_TOO_BIG_FLOOD (MIB_IPV6_ID+40)
#define MIB_IPV6_DOS_NS_FLOOD (MIB_IPV6_ID+41)
#endif
//lan mibs
#define MIB_IPV6_LAN_ORIGIN				(MIB_IPV6_ID+42)
#define MIB_IPV6_ADDR_LAN_LOCAL_PARAM	(MIB_IPV6_ID+43)
#define MIB_IPV6_DHCP6S_POOL_PLTIME			(MIB_IPV6_ID+44)
#define MIB_IPV6_DHCP6S_POOL_VLTIME			(MIB_IPV6_ID+45)
#define MIB_IPV6_DHCP6S_OPTION16_ENABLED	(MIB_IPV6_ID+46)
#define MIB_IPV6_DHCP6S_OPTION17_ENABLED	(MIB_IPV6_ID+47)
typedef enum IPV6_ORIGIN_T_
{
	IPV6_ORIGIN_AUTO=0,	
	IPV6_ORIGIN_STATIC =1,
	IPV6_ORIGIN_SLAAC =2,
	IPV6_ORIGIN_DHCP6C =3,
	IPV6_ORIGIN_DSLITE =4,
	IPV6_ORIGIN_BRIDGE =5,
...
#define MIB_DNS_CLIENT_ENABLE (MIB_IPV6_ID+48)
#ifdef CONFIG_IPV6
#define DNS_CLIENT_SERVER_NUM 10
#else
#define DNS_CLIENT_SERVER_NUM 6
#endif
#define MIB_DNS_CLIENT_SERVER_TBL_NUM	(MIB_IPV6_ID+49)
...
#define MIB_DNS_CLIENT_SERVER_INDEX (MIB_IPV6_ID+52)
#define MIB_DNS_CLIENT_SERVER_ENABLE (MIB_IPV6_ID+53)
#define MIB_DNS_CLIENT_SERVER_STATUS (MIB_IPV6_ID+54)
//#define MIB_DNS_CLIENT_SERVER_ALIAS MIB_IPV6_ID+47
#define MIB_DNS_CLIENT_SERVER_IPADDR (MIB_IPV6_ID+55)
//#define MIB_DNS_CLIENT_SERVER_IF MIB_IPV6_ID+49
#define MIB_DNS_CLIENT_SERVER_TYPE (MIB_IPV6_ID+56)
#endif

#ifdef CONFIG_DSLITE_SUPPORT
#define MIB_IPV6_ADDR_AFTR_PARAM	(MIB_IPV6_ID+57)
#define MIB_DSLITE_MODE				(MIB_IPV6_ID+58)
#endif
#ifdef CONFIG_SIXRD_SUPPORT
#define MIB_IPV6_6RD_PREFIX_PARAM	(MIB_IPV6_ID+59)
#define MIB_IPV4_6RD_MASK_LEN		(MIB_IPV6_ID+60)
#define MIB_IPV4_6RD_BR_ADDR		(MIB_IPV6_ID+61)
#endif
#ifdef CHECK_IPV6_DHCP_OPTION
#define MAX_DHCP6_OPTION16_NUM  4 //for every wan
#define MAX_DHCP6_OPTION17_NUM  4 //for every wan

#define MIB_IPV6_EXT_ID 				6100
#define MIB_DHCP6_OPTION16_ENABLED		(MIB_IPV6_EXT_ID)
#define MIB_DHCP6_OPTION16_TYPE			(MIB_IPV6_EXT_ID+1)
#define MIB_DHCP6_OPTION16_VALUEMODE	(MIB_IPV6_EXT_ID+2)
#define MIB_DHCP6_OPTION16_VALUE		(MIB_IPV6_EXT_ID+3)

#define MIB_DHCP6_OPTION17_ENABLED		(MIB_IPV6_EXT_ID+4)
#define MIB_DHCP6_OPTION17_TYPE			(MIB_IPV6_EXT_ID+5)
#define MIB_DHCP6_OPTION17_SUBOPTCODE	(MIB_IPV6_EXT_ID+6)
#define MIB_DHCP6_OPTION17_SUBOPTDATA	(MIB_IPV6_EXT_ID+7)
#define MIB_DHCP6_OPTION17_VALUE		(MIB_IPV6_EXT_ID+8)

#define MIB_DHCP6_OPTION16_TBL_NUM		(MIB_IPV6_EXT_ID+10)
#define MIB_DHCP6_OPTION16_TBL          ((MIB_DHCP6_OPTION16_TBL_NUM+1) | MIB_TABLE_LIST) 
#define MIB_DHCP6_OPTION16_ADD          ((MIB_DHCP6_OPTION16_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_DHCP6_OPTION16_DEL          ((MIB_DHCP6_OPTION16_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_DHCP6_OPTION16_MOD          ((MIB_DHCP6_OPTION16_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_DHCP6_OPTION16_DELALL       ((MIB_DHCP6_OPTION16_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)

#define MIB_DHCP6_OPTION17_TBL_NUM		(MIB_IPV6_EXT_ID+20)
#define MIB_DHCP6_OPTION17_TBL          ((MIB_DHCP6_OPTION17_TBL_NUM+1) | MIB_TABLE_LIST) 
#define MIB_DHCP6_OPTION17_ADD          ((MIB_DHCP6_OPTION17_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_DHCP6_OPTION17_DEL          ((MIB_DHCP6_OPTION17_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_DHCP6_OPTION17_MOD          ((MIB_DHCP6_OPTION17_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_DHCP6_OPTION17_DELALL       ((MIB_DHCP6_OPTION17_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)
#endif
...
#define MIB_CLUSTER_MANAGE_PERIODIC_INTERVAL 447
#define MIB_CLUSTER_MANAGE_PERIODIC_ENABLE	 448
#define MIB_CLUSTER_MANAGE_ENABLE   		 449
#define CLU_CLIENT_RUNFILE	        "/var/run/clu_client.pid"
#define CLU_SERVER_RUNFILE	        "/var/run/clu_server.pid"
#endif

#define TIMELYCHECK_RUNFILE			"/var/run/timelycheck.pid"
...
#define MIB_ALG_FTP_DISABLE 454
#define MIB_ALG_TFTP_DISABLE 455
#define MIB_ALG_RTSP_DISABLE 456
#define MIB_ALG_PPTP_DISABLE 457
#define MIB_ALG_L2TP_DISABLE 458
#define MIB_ALG_IPSEC_DISABLE 459
#define MIB_ALG_SIP_DISABLE 460
#define MIB_ALG_H323_DISABLE 461
#endif

#define MIB_IGMP_SNOOPING_DISABLE 462
#define MIB_MLD_SNOOPING_DISABLE 463
#define MIB_IGMP_ENABLE 464

#ifdef CONFIG_USER_AIS_SUPER_ACCESS
/*
 *cairui:
 *	According to AIS spec, when SUPER_SECURITY is 1:
 *		1. br0 can not visit boa;
 *		2. IP from WAN side within SUPER_ACCESSLIST can visit boa.
 *  Now CONFIG_USER_AIS_SUPER_ACCESS is selected by CONFIG_USER_CWMP_WHTH_TR098_AIS=y.
 *  By Modifying COMMON_FLAGS.mk can make CONFIG_USER_AIS_SUPER_ACCESS independent from CONFIG_USER_CWMP_WHTH_TR098_AIS.
 *  After all, this is actually a firewall feature isolated from TR-069 or TR-098_AIS.
 */
#define MAX_SUPER_ACCESSLIST_LEN (256)
#define MIB_SUPER_SECURITY		480
#define MIB_SUPER_ACCESSLIST	481
#endif
...
typedef enum { APPTYPE_TR069_INTERNET=0, APPTYPE_INTERNET, APPTYPE_TR069,
		 APPTYPE_OTHER, APPTYPE_VOICE, APPTYPE_TR069_VOICE,
		 APPTYPE_VOICE_INTERNET, APPTYPE_TR069_VOICE_INTERNET, APPTYPE_TR069_BRIDGE, APPTYPE_IPTV,APPTYPE_END } APPTYPE_T;
...
#define MAX_DHCP_OPTION60_NUM  8 //for every wan
#define MAX_DHCP_OPTION125_NUM  8 //for every wan
#define MAX_OPTION_FIELD_LENGTH 96
#define MAX_UPGRADE_URL_LENGTH 128
...
#define MIB_CWMP_DLUL_INTF						CWMP_ID + 35
#define MIB_CWMP_DLUL_DNS_INTF					CWMP_ID + 36
#define MIB_CWMP_DLUL_INTF_SPECIFY_ENABLE		CWMP_ID + 37
#endif /*MULTI_WAN_SUPPORT*/
//user-defined event support
#define MIB_CWMP_USEREVENT_BITMAP				(CWMP_ID + 38)
...
#define MIB_CWMP_UDPCON_ACTNOTIF_LIMIT      CWMP_ID+191	/* UDPConReqAddr */
#define MIB_CWMP_MIB_END				CWMP_ID + 200	/* Reserve 200 mib for tr069*/

#define MIB_CWMP_DEVICE_RECONNECT_DISABLE  9000
#define MIB_CWMP_CHECK_OPTION60_DISABLE 9001  //dhcp server check client option60
#define MIB_CWMP_OPTION125_DISABLE 9002            //dhcp server use option125

#define MIB_CWMP_UPGRADE_URL   9040        //for X_CT-COM_WLANApInfo
#define MIB_CWMP_AUTO_REBOOT   9041	  //for X_CT-COM_WLANApInfo

//for X_CT-COM_DHCPOPTION60 and X_CT-COM_DHCPOPTION125
#define MIB_OPTION_ENABLE 9200
#define MIB_OPTION_VALUE_MODE 9201
#define MIB_OPTION_FIELD_TYPE 9202
#define MIB_OPTION_FIELD_VALUE 9203
#define MIB_OPTION_INSTANCE_NUM 9204

//option 60
#define MIB_DHCP_OPTION60_ENTERPRISE_CODE 9300
#define MIB_DHCP_OPTION60_TBL_NUM 9301
#define MIB_DHCP_OPTION60_TBL  ((MIB_DHCP_OPTION60_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_DHCP_OPTION60_TBL_ADD ((MIB_DHCP_OPTION60_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_DHCP_OPTION60_TBL_DEL ((MIB_DHCP_OPTION60_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_DHCP_OPTION60_TBL_MOD ((MIB_DHCP_OPTION60_TBL_NUM+3)|MIB_DEL_TBL_ENTRY| MIB_MOD_TBL_ENTRY)
#define MIB_DHCP_OPTION60_TBL_DELALL	 ((MIB_DHCP_OPTION60_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

//option 125
#define MIB_DHCP_OPTION125_ENTERPRISE_CODE 9350
#define MIB_DHCP_OPTION125_TBL_NUM 9351
#define MIB_DHCP_OPTION125_TBL  ((MIB_DHCP_OPTION125_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_DHCP_OPTION125_TBL_ADD ((MIB_DHCP_OPTION125_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_DHCP_OPTION125_TBL_DEL ((MIB_DHCP_OPTION125_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_DHCP_OPTION125_TBL_MOD ((MIB_DHCP_OPTION125_TBL_NUM+3)|MIB_DEL_TBL_ENTRY| MIB_MOD_TBL_ENTRY)
#define MIB_DHCP_OPTION125_TBL_DELALL  ((MIB_DHCP_OPTION125_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#endif /*CONFIG_APP_TR069*/

#ifdef CONFIG_APP_VSFTPD
#define MIB_FTPD_ENABLED 950
#define MIB_FTPD_USER_NAME 951
#define MIB_FTPD_PASSWD 952
#define MIB_FTPD_PORT 953
#endif
#ifdef CONFIG_APP_TELNETD
#define MIB_TELNETD_ENABLED 954
#define MIB_TELNETD_USER_NAME 955
#define MIB_TELNETD_PASSWD 956
#define MIB_TELNETD_PORT 957
#endif
...
#endif
#define MIB_PORTFW_MULITWAN_MASK		1030
...
#define MIB_IPFILTER_WANIFACE_ID    1039
...
#ifdef IP_RANGE_MULTI_WAN_SUPPORT
#define MIB_IPFILTER_IP6ADDR_END    1046
#define MIB_IPFILTER_DSTIP6ADDR     1047
#define MIB_IPFILTER_DSTIP6ADDR_END 1048
#endif
...
#ifdef MACFILTER_MODE_SUPPORT
#define MIB_MACFILTER_MODE_ID		1055
#endif
#ifdef DST_MAC_FILTER
#define MIB_MACFILTER_DMACADDR		1054
#endif
...
#define MIB_PIMD_RP_GROUP	1252
#define MIB_PIMD_RP_GROUP_MASK_LEN	1253
#define MIB_PIMD_IF_NAME	1254
#define MIB_PIMD_IF_DR_PRIORITY	1255
#define MIB_PIMD_IF_AL_NETWORK_ADDR 1256
#define MIB_PIMD_IF_AL_NETWORK_MASK_LEN	 1257
#define MIB_PIMD_IF_FL_NETWORK_ADDR 1258
#define MIB_PIMD_IF_FL_NETWORK_MASK_LEN	 1259
#endif
#ifdef CONFIG_APP_MROUTED
#define MIB_MROUTED_IF_NAME	1260
#define MIB_MROUTED_IF_METRIC	1261
#define MIB_MROUTED_IF_THRESHOLD	1262
#define MIB_MROUTED_IF_RATE_LIMIT	1263
#define MIB_MROUTED_IF_BOUNDRY_IP 1264
#define MIB_MROUTED_IF_BOUNDRY_IP_LEN	 1265


#define MIB_MROUTED_TUNNEL_IP_LOCAL	1266
#define MIB_MROUTED_TUNNEL_IP_REMOTE	1267
#define MIB_MROUTED_TUNNEL_METRIC	1268
#define MIB_MROUTED_TUNNEL_SHRESHOLD	1269
#define MIB_MROUTED_TUNNEL_RATE_LIMIT 1270
#define MIB_MROUTED_TUNNEL_BOUNDRY_IP 1271
#define MIB_MROUTED_TUNNEL_BOUNDRY_IP_LEN	 1272

#define MIB_MROUTED_ALTNET_IF_NAME	1273
#define MIB_MROUTED_IF_ALTNET_IP 1274
#define MIB_MROUTED_IF_ALTNET_IP_LEN	 1275
#endif
...
#define MIB_RTL_LINK_QLINK_TIMEOUT          1429
...
#define MIB_RTL_LINK_GW_MODE                1441
#define MIB_RTL_LINK_UPTYPE                 1442

#define MIB_RTL_LINK_EXTEND_OF_SN				1448
#define MIB_RTL_LINK_SYNC					1449

#define MIB_RTL_LINK_ROAMING_SWITCH         1900
#define MIB_RTL_LINK_ROAMING_QOS            1901
#define MIB_RTL_LINK_ROAMING_DETEC_PERIOD   1902
#define MIB_RTL_LINK_ROAMING_START_TIME     1903
#define MIB_RTL_LINK_ROAMING_START_RSSI     1904
#define MIB_RTL_LINK_ROAMING_DEBUG_ON       1905
#define MIB_RTL_LINK_LED_ON                 1906

#ifdef CONFIG_ELINKSDK_SUPPORT
#define MIB_ELINKSDK_STATUS					1907
#define MIB_ELINKSDK_DOWNLOAD_URL			1908
#endif

#define MIB_RTL_LINK_WIFI_TIMER             1909
#endif
...
#ifdef CONFIG_APP_PIMD
#define MIB_RESTART_PIMD	1859
#define MIB_PIMD_ENABLE	1860
#define MIB_PIMD_BSR_PRIORITY	1861
#define MIB_PIMD_RP_PRIORITY	1862
#define MIB_PIMD_RP_TIME	1863
#define MIB_PIMD_STATIC_RP_IP_ADDRESS	1864
#define MIB_PIMD_STATIC_RP_GROUP_ADDRESS	1865
#define MIB_PIMD_STATIC_RP_GROUP_MASK_LEN	1866
#define MIB_PIMD_RP_GROUP_TBL_NUM         1867
#define MIB_PIMD_RP_GROUP_TBL             ((MIB_PIMD_RP_GROUP_TBL_NUM+1)|MIB_TABLE_LIST) 
#define MIB_PIMD_RP_GROUP_ADD             ((MIB_PIMD_RP_GROUP_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_PIMD_RP_GROUP_DEL             ((MIB_PIMD_RP_GROUP_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_PIMD_RP_GROUP_MOD             ((MIB_PIMD_RP_GROUP_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_PIMD_RP_GROUP_DELALL          ((MIB_PIMD_RP_GROUP_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)
#define MIB_PIMD_IF_TBL_NUM         1870
#define MIB_PIMD_IF_TBL             ((MIB_PIMD_IF_TBL_NUM+1)|MIB_TABLE_LIST) 
#define MIB_PIMD_IF_ADD             ((MIB_PIMD_IF_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_PIMD_IF_DEL             ((MIB_PIMD_IF_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_PIMD_IF_MOD             ((MIB_PIMD_IF_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_PIMD_IF_DELALL          ((MIB_PIMD_IF_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)

#endif

#ifdef CONFIG_APP_MROUTED
#define MIB_RESTART_MROUTED	1880
#define MIB_MROUTED_ENABLE	1881
#define MIB_MROUTED_IF_TBL_NUM         1882
#define MIB_MROUTED_IF_TBL             ((MIB_MROUTED_IF_TBL_NUM+1)|MIB_TABLE_LIST) 
#define MIB_MROUTED_IF_ADD             ((MIB_MROUTED_IF_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_MROUTED_IF_DEL             ((MIB_MROUTED_IF_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_MROUTED_IF_MOD             ((MIB_MROUTED_IF_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_MROUTED_IF_DELALL          ((MIB_MROUTED_IF_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)
#define MIB_MROUTED_TUNNEL_TBL_NUM         1885
#define MIB_MROUTED_TUNNEL_TBL             ((MIB_MROUTED_TUNNEL_TBL_NUM+1)|MIB_TABLE_LIST) 
#define MIB_MROUTED_TUNNEL_ADD             ((MIB_MROUTED_TUNNEL_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_MROUTED_TUNNEL_DEL             ((MIB_MROUTED_TUNNEL_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_MROUTED_TUNNEL_MOD             ((MIB_MROUTED_TUNNEL_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_MROUTED_TUNNEL_DELALL          ((MIB_MROUTED_TUNNEL_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)
#define MIB_MROUTED_IF_ALTNET_TBL_NUM         1890
#define MIB_MROUTED_IF_ALTNET_TBL             ((MIB_MROUTED_IF_ALTNET_TBL_NUM+1)|MIB_TABLE_LIST) 
#define MIB_MROUTED_IF_ALTNET_ADD             ((MIB_MROUTED_IF_ALTNET_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_MROUTED_IF_ALTNET_DEL             ((MIB_MROUTED_IF_ALTNET_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_MROUTED_IF_ALTNET_MOD             ((MIB_MROUTED_IF_ALTNET_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_MROUTED_IF_ALTNET_DELALL          ((MIB_MROUTED_IF_ALTNET_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)
#endif
...
#define WLAN_TELCO_SELECTED_ID                          2130
...
/*user defined event*/
enum eCWMP_userevent_types
{
	CWMP_UE_CTCOM = 0,
	CWMP_UE_CMCC,
	CWMP_UE_TYPE_END,
};
#define CWMP_UE_TYPE_SHIFT	28
#endif /*CONFIG_APP_TR069*/
...
#define MIB_INTERNET_WAN_DISABLED     7800
#define MIB_CLEAR_CONFIG_FLAG		7801
#define MIB_GW_SW_VERSION	7802
#define MIB_GW_HW_VERSION	7803

#define MIB_ALIAS_IF_NAME     7804
#define MIB_REAL_IF_NAME		7805
#define MIB_MAP_FLAG	7806
#define MIB_SERVICE_TYPE	7807	 

#define MIB_ALIAS_NAME_MAPPING_NUM	 		7808
#define MIB_ALIAS_NAME_MAPPING_TBL			((MIB_ALIAS_NAME_MAPPING_NUM+1)|MIB_TABLE_LIST)
#define MIB_ALIAS_NAME_MAPPING_ADD			((MIB_ALIAS_NAME_MAPPING_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_ALIAS_NAME_MAPPING_DEL			((MIB_ALIAS_NAME_MAPPING_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_ALIAS_NAME_MAPPING_MOD			((MIB_ALIAS_NAME_MAPPING_NUM+3)|MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_ALIAS_NAME_MAPPING_DELALL	((MIB_ALIAS_NAME_MAPPING_NUM+4)|MIB_DELALL_TBL_ENTRY)
...
/* ==== cmcc qos mib define begin =====================*/
#if defined(CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT)
//MAX_QOS_WANPORT_NUM should as same as Macro MAX_PHY_PORT_NUM in kernel(rtl865x_outputqueue.h)
#define MAX_QOS_WANPORT_NUM           			5
#endif

#if defined(CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT)
#if defined(CONFIG_RTL_8198C) || defined(CONFIG_RTL_8197F)
#define MAX_PER_PORT_QOS_QUEUE_NUM				8
#define MAX_QOS_QUEUE_NUM        				(MAX_QOS_WANPORT_NUM*MAX_PER_PORT_QOS_QUEUE_NUM)
#else
#define MAX_PER_PORT_QOS_QUEUE_NUM				6
#define MAX_QOS_QUEUE_NUM        				(MAX_QOS_WANPORT_NUM*MAX_PER_PORT_QOS_QUEUE_NUM)
#endif
#define MAX_PER_PORT_QOS_APP_NUM				4
#define MAX_QOS_APP_NUM							(MAX_QOS_WANPORT_NUM*MAX_PER_PORT_QOS_APP_NUM)
#define MAX_PER_PORT_CLASS_NUM					10
#define MAX_QOS_CLASS_NUM						(MAX_QOS_WANPORT_NUM*MAX_PER_PORT_CLASS_NUM)
#else
#if defined(CONFIG_RTL_8198C) || defined(CONFIG_RTL_8197F)
#define MAX_QOS_QUEUE_NUM        				8
#else
#define MAX_QOS_QUEUE_NUM        				6
#endif
#define MAX_QOS_APP_NUM							4
#define MAX_QOS_CLASS_NUM						10
//#define MAX_QOS_CAR_NUM							1
#endif

//#define MAX_QOS_CLASS_NUM						10
#define MAX_QOS_CAR_NUM							1
#define MAX_QOS_PER_CLASS_TYPE_NUM				12
#define MAX_QOS_TYPE_NUM	 					(MAX_QOS_PER_CLASS_TYPE_NUM*MAX_QOS_CLASS_NUM)
#define MAX_TYPE_NAME_LEN						32
#define MAX_TYPE_VALUE_LEN						128
#define MAX_APP_NAME_LEN						16
#define MAX_PROTOCOL_LEN						16
#define MAX_CAR_MODE_LEN						512
#define MAX_IFACE_NAME_LEN						32


#define QOS_SMAC								"SMAC"
#define QOS_DMAC								"DMAC"
#define QOS_SIP									"SIP"
#define QOS_DIP									"DIP"
#define QOS_SPORT								"SPORT"
#define QOS_DPORT								"DPORT"
#define QOS_DSCP								"DSCP"
#define QOS_TOS									"TOS"
#define QOS_DOT1P								"8021P"
#define QOS_WAN									"WANInterface"
#define QOS_LAN									"LANInterface"

#if defined(CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT)
#define MIB_QOS_WAN_PORT 						11002
#define MIB_QOS_WAN_INDEX						11003
#else
#define MIB_QOS_ENABLE                          8000
#define MIB_QOS_MODE                          	8001
#define MIB_QOS_UPLINK_SPEED               		8002
#define MIB_QOS_PLAN	                       	8004
#define MIB_QOS_ENFORCE_WEIGHT                  8005
#define MIB_QOS_EN_DSCP_REAMRK          		8006
#define MIB_QOS_EN_DOT1P_REMARK           		8007
#endif
#define MIB_QOS_DOWNLINK_SPEED               	8003
#define MIB_CURRENT_CLASSID						8008
#define MIB_CURRENT_TYPEID						8009
#define MIB_UPLINK_QOS_OPERATION				8010
#define MIB_SHAPING_QOS_OEPRATION				8011
#define MIB_CURRENT_CARID						8012


// type tbl
#define MIB_QOS_TYPE_TBL_NUM  					8020
#define MIB_QOS_TYPE_TBL						((MIB_QOS_TYPE_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_TYPE_ADD						((MIB_QOS_TYPE_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_TYPE_DEL						((MIB_QOS_TYPE_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_TYPE_MOD						((MIB_QOS_TYPE_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_TYPE_DELALL						((MIB_QOS_TYPE_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#if defined(CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT)
#define MIB_QOSTYPE_WANPORT						(MIB_QOS_TYPE_TBL_NUM+10)
#define MIB_QOSTYPE_INSTANCENUM					(MIB_QOS_TYPE_TBL_NUM+11)
#define MIB_QOSTYPE_CLASSID						(MIB_QOS_TYPE_TBL_NUM+12)
#define MIB_QOSTYPE_NAME						(MIB_QOS_TYPE_TBL_NUM+13)
#define MIB_QOSTYPE_MIN							(MIB_QOS_TYPE_TBL_NUM+14)
#define MIB_QOSTYPE_MAX							(MIB_QOS_TYPE_TBL_NUM+15)
#define MIB_QOSTYPE_PROTO						(MIB_QOS_TYPE_TBL_NUM+16)
#else
#define MIB_QOSTYPE_INSTANCENUM					(MIB_QOS_TYPE_TBL_NUM+10)
#define MIB_QOSTYPE_CLASSID						(MIB_QOS_TYPE_TBL_NUM+11)
#define MIB_QOSTYPE_NAME						(MIB_QOS_TYPE_TBL_NUM+12)
#define MIB_QOSTYPE_MIN							(MIB_QOS_TYPE_TBL_NUM+13)
#define MIB_QOSTYPE_MAX							(MIB_QOS_TYPE_TBL_NUM+14)
#define MIB_QOSTYPE_PROTO						(MIB_QOS_TYPE_TBL_NUM+15)
#endif


// class tbl
#define MIB_QOS_CLASS_TBL_NUM                   8070
...
#if defined(CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT)
#define MIB_QOSCLASS_WANPORT					(MIB_QOS_CLASS_TBL_NUM+10)
#define MIB_QOSCLASS_INSTANCENUM                (MIB_QOS_CLASS_TBL_NUM+11)
#define MIB_QOSCLASS_QUEUE						(MIB_QOS_CLASS_TBL_NUM+12)
#define MIB_QOSCLASS_DSCP_MARK					(MIB_QOS_CLASS_TBL_NUM+13)
#define MIB_QOSCLASS_DOT1P_MARK					(MIB_QOS_CLASS_TBL_NUM+14)
#else
#define MIB_QOSCLASS_INSTANCENUM                (MIB_QOS_CLASS_TBL_NUM+10)
#define MIB_QOSCLASS_QUEUE						(MIB_QOS_CLASS_TBL_NUM+11)
#define MIB_QOSCLASS_DSCP_MARK					(MIB_QOS_CLASS_TBL_NUM+12)
#define MIB_QOSCLASS_DOT1P_MARK					(MIB_QOS_CLASS_TBL_NUM+13)
#endif

// rule tbl
#define MIB_QOS_RULE_TBL_NUM                   	8100
#define MIB_QOS_RULE_TBL                       ((MIB_QOS_RULE_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_RULE_ADD                       ((MIB_QOS_RULE_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_RULE_DEL                       ((MIB_QOS_RULE_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_RULE_MOD                       ((MIB_QOS_RULE_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_RULE_DELALL                    ((MIB_QOS_RULE_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#if defined(CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT)
#define MIB_QOSRULE_WANPORT						(MIB_QOS_RULE_TBL_NUM+10)
#define MIB_QOSRULE_INSTANCENUM					(MIB_QOS_RULE_TBL_NUM+11)
#define MIB_QOSRULE_QUEUE						(MIB_QOS_RULE_TBL_NUM+12)
#define MIB_QOSRULE_DSCP_MARK					(MIB_QOS_RULE_TBL_NUM+13)
#define MIB_QOSRULE_DOT1P_MARK					(MIB_QOS_RULE_TBL_NUM+14)
#define MIB_QOSRULE_SOURCE_MAC_START			(MIB_QOS_RULE_TBL_NUM+15)
#define MIB_QOSRULE_SOURCE_MAC_END				(MIB_QOS_RULE_TBL_NUM+16)
#define MIB_QOSRULE_DEST_MAC_START				(MIB_QOS_RULE_TBL_NUM+17)
#define MIB_QOSRULE_DEST_MAC_END				(MIB_QOS_RULE_TBL_NUM+18)
#define MIB_QOSRULE_SOURCE_IP_START				(MIB_QOS_RULE_TBL_NUM+19)
#define MIB_QOSRULE_SOURCE_IP_END				(MIB_QOS_RULE_TBL_NUM+20)
#define MIB_QOSRULE_DEST_IP_START				(MIB_QOS_RULE_TBL_NUM+21)
#define MIB_QOSRULE_DEST_IP_END					(MIB_QOS_RULE_TBL_NUM+22)
#define MIB_QOSRULE_SOURCE_PORT					(MIB_QOS_RULE_TBL_NUM+23)
#define MIB_QOSRULE_SOURCE_PORT_RANGE_MAX		(MIB_QOS_RULE_TBL_NUM+24)
#define MIB_QOSRULE_DEST_PORT					(MIB_QOS_RULE_TBL_NUM+25)
#define MIB_QOSRULE_DEST_PORT_RANGE_MAX			(MIB_QOS_RULE_TBL_NUM+26)
#define MIB_QOSRULE_DSCP_START					(MIB_QOS_RULE_TBL_NUM+27)
#define MIB_QOSRULE_DSCP_END					(MIB_QOS_RULE_TBL_NUM+28)
#define MIB_QOSRULE_TOS_START					(MIB_QOS_RULE_TBL_NUM+29)
#define MIB_QOSRULE_TOS_END						(MIB_QOS_RULE_TBL_NUM+30)
#define MIB_QOSRULE_DOT1P_START					(MIB_QOS_RULE_TBL_NUM+31)
#define MIB_QOSRULE_DOT1P_END					(MIB_QOS_RULE_TBL_NUM+32)
#define MIB_QOSRULE_WAN_INTERFACE_START			(MIB_QOS_RULE_TBL_NUM+33)
#define MIB_QOSRULE_WAN_INTERFACE_END			(MIB_QOS_RULE_TBL_NUM+34)
#define MIB_QOSRULE_LAN_INTERFACE_START			(MIB_QOS_RULE_TBL_NUM+35)
#define MIB_QOSRULE_LAN_INTERFACE_END			(MIB_QOS_RULE_TBL_NUM+36)
#define MIB_QOSRULE_PROTO						(MIB_QOS_RULE_TBL_NUM+37)
#else
#define MIB_QOSRULE_INSTANCENUM					(MIB_QOS_RULE_TBL_NUM+10)
#define MIB_QOSRULE_QUEUE						(MIB_QOS_RULE_TBL_NUM+11)
#define MIB_QOSRULE_DSCP_MARK					(MIB_QOS_RULE_TBL_NUM+12)
#define MIB_QOSRULE_DOT1P_MARK					(MIB_QOS_RULE_TBL_NUM+13)
#define MIB_QOSRULE_SOURCE_MAC_START			(MIB_QOS_RULE_TBL_NUM+14)
#define MIB_QOSRULE_SOURCE_MAC_END				(MIB_QOS_RULE_TBL_NUM+15)
#define MIB_QOSRULE_DEST_MAC_START				(MIB_QOS_RULE_TBL_NUM+16)
#define MIB_QOSRULE_DEST_MAC_END				(MIB_QOS_RULE_TBL_NUM+17)
#define MIB_QOSRULE_SOURCE_IP_START				(MIB_QOS_RULE_TBL_NUM+18)
#define MIB_QOSRULE_SOURCE_IP_END				(MIB_QOS_RULE_TBL_NUM+19)
#define MIB_QOSRULE_DEST_IP_START				(MIB_QOS_RULE_TBL_NUM+20)
#define MIB_QOSRULE_DEST_IP_END					(MIB_QOS_RULE_TBL_NUM+21)
#define MIB_QOSRULE_SOURCE_PORT					(MIB_QOS_RULE_TBL_NUM+22)
#define MIB_QOSRULE_SOURCE_PORT_RANGE_MAX		(MIB_QOS_RULE_TBL_NUM+23)
#define MIB_QOSRULE_DEST_PORT					(MIB_QOS_RULE_TBL_NUM+24)
#define MIB_QOSRULE_DEST_PORT_RANGE_MAX			(MIB_QOS_RULE_TBL_NUM+25)
#define MIB_QOSRULE_DSCP_START					(MIB_QOS_RULE_TBL_NUM+26)
#define MIB_QOSRULE_DSCP_END					(MIB_QOS_RULE_TBL_NUM+27)
#define MIB_QOSRULE_TOS_START					(MIB_QOS_RULE_TBL_NUM+28)
#define MIB_QOSRULE_TOS_END						(MIB_QOS_RULE_TBL_NUM+29)
#define MIB_QOSRULE_DOT1P_START					(MIB_QOS_RULE_TBL_NUM+30)
#define MIB_QOSRULE_DOT1P_END					(MIB_QOS_RULE_TBL_NUM+31)
#define MIB_QOSRULE_WAN_INTERFACE_START			(MIB_QOS_RULE_TBL_NUM+32)
#define MIB_QOSRULE_WAN_INTERFACE_END			(MIB_QOS_RULE_TBL_NUM+33)
#define MIB_QOSRULE_LAN_INTERFACE_START			(MIB_QOS_RULE_TBL_NUM+34)
#define MIB_QOSRULE_LAN_INTERFACE_END			(MIB_QOS_RULE_TBL_NUM+35)
#define MIB_QOSRULE_PROTO						(MIB_QOS_RULE_TBL_NUM+36)
#endif

// queue tbl
#define MIB_QOS_QUEUE_TBL_NUM                   8200
...
#if defined(CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT)
#define MIB_QOSQUEUE_WANPORT					(MIB_QOS_QUEUE_TBL_NUM+10)
#define MIB_QOSQUEUE_INSTANCENUM				(MIB_QOS_QUEUE_TBL_NUM+11)
#define MIB_QOSQUEUE_ENABLE						(MIB_QOS_QUEUE_TBL_NUM+12)
#define MIB_QOSQUEUE_PRIORITY					(MIB_QOS_QUEUE_TBL_NUM+13)
#define MIB_QOSQUEUE_WEIGHT						(MIB_QOS_QUEUE_TBL_NUM+14)
#else
#define MIB_QOSQUEUE_INSTANCENUM				(MIB_QOS_QUEUE_TBL_NUM+10)
#define MIB_QOSQUEUE_ENABLE						(MIB_QOS_QUEUE_TBL_NUM+11)
#define MIB_QOSQUEUE_PRIORITY					(MIB_QOS_QUEUE_TBL_NUM+12)
#define MIB_QOSQUEUE_WEIGHT						(MIB_QOS_QUEUE_TBL_NUM+13)
#endif

#if defined(CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT)
#define MIB_QOS_WANPORT_TBL_NUM					13000
#define MIB_QOS_WANPORT_TBL						((MIB_QOS_WANPORT_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_WANPORT_ADD						((MIB_QOS_WANPORT_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_WANPORT_DEL						((MIB_QOS_WANPORT_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_WANPORT_MOD						((MIB_QOS_WANPORT_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_WANPORT_DELALL					((MIB_QOS_WANPORT_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_QOS_WANPORT_INSTANCENUM				(MIB_QOS_WANPORT_TBL_NUM+10)
#define MIB_QOS_WANPORT_SET						(MIB_QOS_WANPORT_TBL_NUM+11)
#define MIB_QOS_WANPORT_NAME					(MIB_QOS_WANPORT_TBL_NUM+12)
#define MIB_QOS_WANPORT_ENABLE					(MIB_QOS_WANPORT_TBL_NUM+13)
#define MIB_QOS_WANPORT_MODE					(MIB_QOS_WANPORT_TBL_NUM+14)
#define MIB_QOS_WANPORT_UPLINK_SPEED			(MIB_QOS_WANPORT_TBL_NUM+15)
#define MIB_QOS_WANPORT_PLAN					(MIB_QOS_WANPORT_TBL_NUM+16)
#define MIB_QOS_WANPORT_ENFORCE_WEIGHT			(MIB_QOS_WANPORT_TBL_NUM+17)
#define MIB_QOS_WANPORT_EN_DSCP_REAMRK			(MIB_QOS_WANPORT_TBL_NUM+18)
#define MIB_QOS_WANPORT_EN_DOT1P_REMARK			(MIB_QOS_WANPORT_TBL_NUM+19)
#endif

// app tbl

#define MIB_QOS_APP_TBL_NUM                   	8250
#define MIB_QOS_APP_TBL                       	((MIB_QOS_APP_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_APP_ADD                       	((MIB_QOS_APP_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_APP_DEL                       	((MIB_QOS_APP_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_APP_MOD                       	((MIB_QOS_APP_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_APP_DELALL                    	((MIB_QOS_APP_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#if defined(CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT)
#define MIB_QOSAPP_WANPORT 						(MIB_QOS_APP_TBL_NUM+10)
#define MIB_QOSAPP_INSTANCENUM					(MIB_QOS_APP_TBL_NUM+11)
#define MIB_QOSAPP_NAME							(MIB_QOS_APP_TBL_NUM+12)
#define MIB_QOSAPP_QUEUE						(MIB_QOS_APP_TBL_NUM+13)
#else
#define MIB_QOSAPP_INSTANCENUM					(MIB_QOS_APP_TBL_NUM+10)
#define MIB_QOSAPP_NAME							(MIB_QOS_APP_TBL_NUM+11)
#define MIB_QOSAPP_QUEUE						(MIB_QOS_APP_TBL_NUM+12)
#endif

// car tbl
#define MIB_QOS_CAR_TBL_NUM                   	8300
#define MIB_QOS_CAR_TBL                       	((MIB_QOS_CAR_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_CAR_ADD                       	((MIB_QOS_CAR_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_CAR_DEL                       	((MIB_QOS_CAR_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_CAR_MOD                       	((MIB_QOS_CAR_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_CAR_DELALL                    	((MIB_QOS_CAR_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_QOSCAR_INSTANCENUM					(MIB_QOS_CAR_TBL_NUM+10)
#define MIB_QOSCAR_UP_MODE						(MIB_QOS_CAR_TBL_NUM+11)
#define MIB_QOSCAR_UP_IFACE						(MIB_QOS_CAR_TBL_NUM+12)
#define MIB_QOSCAR_UP_VLAN						(MIB_QOS_CAR_TBL_NUM+13)
#define MIB_QOSCAR_UP_IPRANGE					(MIB_QOS_CAR_TBL_NUM+14)
#define MIB_QOSCAR_DOWN_MODE					(MIB_QOS_CAR_TBL_NUM+15)
#define MIB_QOSCAR_DOWN_IFACE					(MIB_QOS_CAR_TBL_NUM+16)
#define MIB_QOSCAR_DOWN_VLAN					(MIB_QOS_CAR_TBL_NUM+17)
#define MIB_QOSCAR_DOWN_IPRANGE					(MIB_QOS_CAR_TBL_NUM+18)

// car iface tbl
#define MIB_QOS_CAR_UP_IFACE_TBL_NUM			8350
#define MIB_QOS_CAR_UP_IFACE_TBL                ((MIB_QOS_CAR_UP_IFACE_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_CAR_UP_IFACE_ADD                ((MIB_QOS_CAR_UP_IFACE_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_CAR_UP_IFACE_DEL                ((MIB_QOS_CAR_UP_IFACE_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_CAR_UP_IFACE_MOD                ((MIB_QOS_CAR_UP_IFACE_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_CAR_UP_IFACE_DELALL             ((MIB_QOS_CAR_UP_IFACE_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_QOS_CAR_DOWN_IFACE_TBL_NUM			8360
#define MIB_QOS_CAR_DOWN_IFACE_TBL              ((MIB_QOS_CAR_DOWN_IFACE_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_CAR_DOWN_IFACE_ADD              ((MIB_QOS_CAR_DOWN_IFACE_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_CAR_DOWN_IFACE_DEL              ((MIB_QOS_CAR_DOWN_IFACE_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_CAR_DOWN_IFACE_MOD              ((MIB_QOS_CAR_DOWN_IFACE_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_CAR_DOWN_IFACE_DELALL           ((MIB_QOS_CAR_DOWN_IFACE_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_QOSCAR_IFACE_INSTANCENUM			(MIB_QOS_CAR_UP_IFACE_TBL_NUM+20)
#define MIB_QOSCAR_IFACE_CARID					(MIB_QOS_CAR_UP_IFACE_TBL_NUM+21)
#define MIB_QOSCAR_IFACE_NAME					(MIB_QOS_CAR_UP_IFACE_TBL_NUM+22)
#define MIB_QOSCAR_IFACE_SHAPING				(MIB_QOS_CAR_UP_IFACE_TBL_NUM+23)


// car vlan tbl
#define MIB_QOS_CAR_UP_VLAN_TBL_NUM             8400
#define MIB_QOS_CAR_UP_VLAN_TBL                 ((MIB_QOS_CAR_UP_VLAN_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_CAR_UP_VLAN_ADD                 ((MIB_QOS_CAR_UP_VLAN_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_CAR_UP_VLAN_DEL                 ((MIB_QOS_CAR_UP_VLAN_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_CAR_UP_VLAN_MOD                 ((MIB_QOS_CAR_UP_VLAN_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_CAR_UP_VLAN_DELALL              ((MIB_QOS_CAR_UP_VLAN_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_QOS_CAR_DOWN_VLAN_TBL_NUM           8410
#define MIB_QOS_CAR_DOWN_VLAN_TBL               ((MIB_QOS_CAR_DOWN_VLAN_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_CAR_DOWN_VLAN_ADD               ((MIB_QOS_CAR_DOWN_VLAN_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_CAR_DOWN_VLAN_DEL               ((MIB_QOS_CAR_DOWN_VLAN_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_CAR_DOWN_VLAN_MOD               ((MIB_QOS_CAR_DOWN_VLAN_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_CAR_DOWN_VLAN_DELALL            ((MIB_QOS_CAR_DOWN_VLAN_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_QOSCAR_VLAN_INSTANCENUM				(MIB_QOS_CAR_UP_VLAN_TBL_NUM+20)
#define MIB_QOSCAR_VLAN_CARID					(MIB_QOS_CAR_UP_VLAN_TBL_NUM+21)
#define MIB_QOSCAR_VLANID						(MIB_QOS_CAR_UP_VLAN_TBL_NUM+22)
#define MIB_QOSCAR_VLAN_SHAPING					(MIB_QOS_CAR_UP_VLAN_TBL_NUM+23)

// car ip tbl
#define MIB_QOS_CAR_UP_IP_TBL_NUM               8450
#define MIB_QOS_CAR_UP_IP_TBL                   ((MIB_QOS_CAR_UP_IP_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_CAR_UP_IP_ADD                   ((MIB_QOS_CAR_UP_IP_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_CAR_UP_IP_DEL                   ((MIB_QOS_CAR_UP_IP_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_CAR_UP_IP_MOD                   ((MIB_QOS_CAR_UP_IP_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_CAR_UP_IP_DELALL                ((MIB_QOS_CAR_UP_IP_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_QOS_CAR_DOWN_IP_TBL_NUM             8460
#define MIB_QOS_CAR_DOWN_IP_TBL                 ((MIB_QOS_CAR_DOWN_IP_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_CAR_DOWN_IP_ADD                 ((MIB_QOS_CAR_DOWN_IP_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_CAR_DOWN_IP_DEL                 ((MIB_QOS_CAR_DOWN_IP_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_CAR_DOWN_IP_MOD                 ((MIB_QOS_CAR_DOWN_IP_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_CAR_DOWN_IP_DELALL              ((MIB_QOS_CAR_DOWN_IP_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_QOSCAR_IP_INSTANCENUM				(MIB_QOS_CAR_UP_IP_TBL_NUM+20)
#define MIB_QOSCAR_IP_CARID						(MIB_QOS_CAR_UP_IP_TBL_NUM+21)
#define MIB_QOSCAR_IP_START						(MIB_QOS_CAR_UP_IP_TBL_NUM+22)
#define MIB_QOSCAR_IP_END						(MIB_QOS_CAR_UP_IP_TBL_NUM+23)
#define MIB_QOSCAR_IP_SHAPING					(MIB_QOS_CAR_UP_IP_TBL_NUM+24)


#if defined(CONFIG_MAC_SHAPING_QOS)
// car mac tbl
#define MIB_QOS_CAR_UP_MAC_TBL_NUM               8500
#define MIB_QOS_CAR_UP_MAC_TBL                   ((MIB_QOS_CAR_UP_MAC_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_CAR_UP_MAC_ADD                   ((MIB_QOS_CAR_UP_MAC_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_CAR_UP_MAC_DEL                   ((MIB_QOS_CAR_UP_MAC_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_CAR_UP_MAC_MOD                   ((MIB_QOS_CAR_UP_MAC_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_CAR_UP_MAC_DELALL                ((MIB_QOS_CAR_UP_MAC_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_QOS_CAR_DOWN_MAC_TBL_NUM             8510
#define MIB_QOS_CAR_DOWN_MAC_TBL                 ((MIB_QOS_CAR_DOWN_MAC_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_QOS_CAR_DOWN_MAC_ADD                 ((MIB_QOS_CAR_DOWN_MAC_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_QOS_CAR_DOWN_MAC_DEL                 ((MIB_QOS_CAR_DOWN_MAC_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_QOS_CAR_DOWN_MAC_MOD                 ((MIB_QOS_CAR_DOWN_MAC_TBL_NUM+3)|MIB_DEL_TBL_ENTRY|MIB_MOD_TBL_ENTRY)
#define MIB_QOS_CAR_DOWN_MAC_DELALL              ((MIB_QOS_CAR_DOWN_MAC_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_QOSCAR_MAC_INSTANCENUM				(MIB_QOS_CAR_UP_MAC_TBL_NUM+20)
#define MIB_QOSCAR_MAC_CARID					(MIB_QOS_CAR_UP_MAC_TBL_NUM+21)
#define MIB_QOSCAR_MAC_ADDR						(MIB_QOS_CAR_UP_MAC_TBL_NUM+22)
#define MIB_QOSCAR_MAC_SHAPING					(MIB_QOS_CAR_UP_MAC_TBL_NUM+24)
#endif

/* ==== cmcc qos mib define end =====================*/
...
// self-defined
#define MIB_QOSCLASS_WANINTERFACE                  				(MIB_QOS_CLASS_TBL_NUM+90)
#define MIB_QOSCLASS_IP_VERSION                  				(MIB_QOS_CLASS_TBL_NUM+91)
#define MIB_QOSCLASS_V4_TYPE_OF_SERVICE							(MIB_QOS_CLASS_TBL_NUM+92)

#if defined(CONFIG_IPV6)
#define MIB_QOSCLASS_SOURCE_IPV6								(MIB_QOS_CLASS_TBL_NUM+93)
#define MIB_QOSCLASS_DEST_IPV6									(MIB_QOS_CLASS_TBL_NUM+94)
#define MIB_QOSCLASS_FLOW_LABEL									(MIB_QOS_CLASS_TBL_NUM+95)
#define MIB_QOSCLASS_V6_TRAFFIC_CLASS_MATCH						(MIB_QOS_CLASS_TBL_NUM+96)
#endif
...
#define MIB_QOSQUEUE_WANINTERFACE               (MIB_QOS_QUEUE_TBL_NUM+25)
#define MIB_QOSQUEUE_GUARANMIN_RATE             (MIB_QOS_QUEUE_TBL_NUM+26) 
...
#define MIB_AWIFI_ENABLED			3700
#define MIB_AWIFI_DEBUG_LEVEL		3701
#define MIB_AWIFI_WAN_IDX			3702

#define MIB_AWIFI_TRUSTED_MAC_TBL_NUM  3703
#define MIB_AWIFI_TRUSTED_MAC_TBL	 		((MIB_AWIFI_TRUSTED_MAC_TBL_NUM+1) | MIB_TABLE_LIST) 
#define MIB_AWIFI_TRUSTED_MAC_ADD          ((MIB_AWIFI_TRUSTED_MAC_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_AWIFI_TRUSTED_MAC_DEL          ((MIB_AWIFI_TRUSTED_MAC_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_AWIFI_TRUSTED_MAC_MOD          ((MIB_AWIFI_TRUSTED_MAC_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_AWIFI_TRUSTED_MAC_DELALL       ((MIB_AWIFI_TRUSTED_MAC_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)

#define MIB_AWIFI_TRUSTED_URL_TBL_NUM  3704
#define MIB_AWIFI_TRUSTED_URL_TBL	 		((MIB_AWIFI_TRUSTED_URL_TBL_NUM+1) | MIB_TABLE_LIST) 
#define MIB_AWIFI_TRUSTED_URL_ADD          ((MIB_AWIFI_TRUSTED_URL_TBL_NUM+2) | MIB_ADD_TBL_ENTRY)
#define MIB_AWIFI_TRUSTED_URL_DEL          ((MIB_AWIFI_TRUSTED_URL_TBL_NUM+3) | MIB_DEL_TBL_ENTRY)
#define MIB_AWIFI_TRUSTED_URL_MOD          ((MIB_AWIFI_TRUSTED_URL_TBL_NUM+3) | MIB_DEL_TBL_ENTRY | MIB_MOD_TBL_ENTRY)
#define MIB_AWIFI_TRUSTED_URL_DELALL       ((MIB_AWIFI_TRUSTED_URL_TBL_NUM+4) | MIB_DELALL_TBL_ENTRY)

#define MIB_AWIFI_TRUSTED_MAC_VALUE		3705
#define MIB_AWIFI_TRUSTED_MAC_COMMENT	3706

#define MIB_AWIFI_TRUSTED_URL_VALUE		3707
#define MIB_AWIFI_TRUSTED_URL_COMMENT	3708

#ifdef CONFIG_APP_AWIFI_AUDIT_SUPPORT
#define MIB_AWIFI_AUDIT_TYPE		3710
#endif
#endif
...
#define MIB_MODULES_REINIT_FLAG 3998
#define REINIT_FLAG_SYSTEM 0x1
#define REINIT_FLAG_NAT 0x2
#define REINIT_FLAG_WLAN 0x4
#define REINIT_FLAG_LAN 0x8
#define REINIT_FLAG_LAN_DHCP 0x10
#define REINIT_FLAG_WLAN_APP 0x20
#define REINIT_FLAG_WAN 0x40
#define REINIT_FLAG_APP 0x80
#define REINIT_FLAG_ALL 0xffff
#endif
...
#define MIB_ID_IPV6_OFFSET 				2700	/*IPv6 mib offset change from 2000 to 2700 avoid conflict with qos*/
#define MIB_ID_STRUCT_OFFSET  			2900	/*struct mib offset*/
...
#define MIB_WANIFACE_L2TP_DEFAULT_GW		MIB_WAN_LOGICAL_ADDR + 72
...
#define MIB_WAN_QOS_ENABLE							MIB_WAN_LOGICAL_ADDR + 90
#define MIB_WANIFACE_QOS_AUTO_UL_SPEED			MIB_WAN_LOGICAL_ADDR + 91
#define MIB_WANIFACE_QOS_MANUAL_UL_SPEED		MIB_WAN_LOGICAL_ADDR + 92
#define MIB_WANIFACE_QOS_AUTO_DL_SPEED		MIB_WAN_LOGICAL_ADDR + 93
#define MIB_WANIFACE_QOS_MANUAL_DL_SPEED		MIB_WAN_LOGICAL_ADDR + 94 

#define MIB_WANIFACE_PPP_SESSION_NUM	MIB_WAN_LOGICAL_ADDR+95
#define MIB_WANIFACE_PPP_SERVER_MAC		MIB_WAN_LOGICAL_ADDR+96
#define MIB_WANIFACE_DNS_DISABLE		MIB_WAN_LOGICAL_ADDR+97

#if defined(CONFIG_IPV6)
#define MIB_WAN_QOS_V6_ENABLE					MIB_WAN_LOGICAL_ADDR + 98
#endif
#define MIB_WANIFACE_HW_NAT_ENABLED			MIB_WAN_LOGICAL_ADDR + 99
#ifdef MAIN_WAN_MAPPING
#define MIB_WANIFACE_MAPPING_WANIFIDX		MIB_WAN_LOGICAL_ADDR + 100
#endif
#define MIB_WANIFACE_NAT_DISABLE			MIB_WAN_LOGICAL_ADDR+101

#define MIB_WANIFACE_L2TP_WAN_IP_DYNAMIC 		MIB_WAN_LOGICAL_ADDR+102
#define MIB_WANIFACE_L2TP_GET_SERV_BY_DOMAIN 	MIB_WAN_LOGICAL_ADDR+103
#define MIB_WANIFACE_L2TP_SERVER_DOMAIN			MIB_WAN_LOGICAL_ADDR+104
#define MIB_WANIFACE_L2TP_PAYLOAD				MIB_WAN_LOGICAL_ADDR+105
#define MIB_WANIFACE_L2TP_PAYLOAD_LENGTH		MIB_WAN_LOGICAL_ADDR+106
#define MIB_WANIFACE_L2TP_NS						MIB_WAN_LOGICAL_ADDR+107

#ifdef CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT
#define MIB_WANIFACE_PORT_ID						MIB_WAN_LOGICAL_ADDR+108
#define MIB_WANIFACE_WAN_ETH_NAME						MIB_WAN_LOGICAL_ADDR+109
#define MIB_WANIFACE_WAN_PPP_NAME						MIB_WAN_LOGICAL_ADDR+110

#define MIB_LAN_DEV_MAPPING_TO_PHY_PORT				MIB_WAN_LOGICAL_ADDR+111
#define MIB_WAN_LOGIC_PORT_MAPPING_TO_PHY_PORT				MIB_WAN_LOGICAL_ADDR+112
#endif
...
#define MIB_WANIFACE_IPV6_LINK_TYPE				MIB_IPV6_LOGICAL_ADDR+2
#define MIB_WANIFACE_IPV6_ORIGIN				MIB_IPV6_LOGICAL_ADDR+3
#define MIB_WANIFACE_IPV6_ADDR					MIB_IPV6_LOGICAL_ADDR+4
#define MIB_WANIFACE_IPV6_GW					MIB_IPV6_LOGICAL_ADDR+5
#define MIB_WANIFACE_IPV6_DNS1					MIB_IPV6_LOGICAL_ADDR+6
#define MIB_WANIFACE_IPV6_DNS2					MIB_IPV6_LOGICAL_ADDR+7
#define MIB_WANIFACE_IPV6_DHCPV6C_PARAM			MIB_IPV6_LOGICAL_ADDR+8
#define MIB_WANIFACE_IPV6_DHCP_PD_ENABLE		MIB_IPV6_LOGICAL_ADDR+9
#define MIB_WANIFACE_IPV6_DHCP_RAPID_COMMIT_ENABLE	MIB_IPV6_LOGICAL_ADDR+10
#define MIB_WANIFACE_IPV6_DHCP_REQ_ADDR_ENABLE	MIB_IPV6_LOGICAL_ADDR+11
//#if defined(CONFIG_ISP_MLDPROXY_MULTIWAN)
#define MIB_WANIFACE_ENABLE_MLDPROXY					MIB_IPV6_LOGICAL_ADDR + 12
//#endif
#define MIB_WANIFACE_IPV6_DSLITE_ENABLE			MIB_IPV6_LOGICAL_ADDR+13
#define MIB_WANIFACE_IPV6_DSLITE_MODE			MIB_IPV6_LOGICAL_ADDR+14
#define MIB_WANIFACE_IPV6_ADDR_AFTR_PARAM		MIB_IPV6_LOGICAL_ADDR+15
#ifdef CONFIG_SIXRD_SUPPORT
#define MIB_WANIFACE_IPV6_6RD_PREFIX_PARAM		MIB_IPV6_LOGICAL_ADDR+16
#define MIB_WANIFACE_IPV4_6RD_MASK_LEN			MIB_IPV6_LOGICAL_ADDR+17
#define MIB_WANIFACE_IPV4_6RD_BR_ADDR			MIB_IPV6_LOGICAL_ADDR+18
#endif
#define MIB_WANIFACE_IPV6_ADDR_ALIAS			MIB_IPV6_LOGICAL_ADDR+19
#define MIB_WANIFACE_IPV6_PREFIX_ALIAS			MIB_IPV6_LOGICAL_ADDR+20
#if 0
#define MIB_WANIFACE_IPV6_ALIAS					MIB_IPV6_LOGICAL_ADDR+4
#define MIB_WANIFACE_IPV6_CHILD_PREFIX			MIB_IPV6_LOGICAL_ADDR+7
#define MIB_WANIFACE_IPV6_DNS_AUTO				MIB_IPV6_LOGICAL_ADDR+9
#define MIB_WANIFACE_IPV6_MLD_PROXY_DISABLED	MIB_IPV6_LOGICAL_ADDR+12
#define MIB_WANIFACE_IPV6_PREFIX_TYPE			MIB_IPV6_LOGICAL_ADDR+13
#define MIB_WANIFACE_IPV6_PREFIX_ALIAS			MIB_IPV6_LOGICAL_ADDR+14
#define MIB_WANIFACE_IPV6_PREFIX_ADDR			MIB_IPV6_LOGICAL_ADDR+15
#define MIB_WANIFACE_IPV6_PREFIX_ORIGIN			MIB_IPV6_LOGICAL_ADDR+16
#define MIB_WANIFACE_IPV6_PREFIX_CHILD_PREFIX	MIB_IPV6_LOGICAL_ADDR+17
#define MIB_LANIFACE_IPV6_ALIAS					MIB_IPV6_LOGICAL_ADDR+18
#define MIB_LANIFACE_IPV6_MANUAL_CONFIG			MIB_IPV6_LOGICAL_ADDR+22
#endif
#ifdef CONFIG_CMCC  // for CT UI display
#define MIB_WANIFACE_IPV6_MANUAL_CONFIG			MIB_IPV6_LOGICAL_ADDR+21
#endif
#endif
/*IPv6 mib define end */
...
#define CONFIG_RTL_LIFETIME_SUPPORT
#ifdef CONFIG_RTL_LIFETIME_SUPPORT
#define WLAN_LIFETIME_SUPPORT
#ifdef WLAN_LIFETIME_SUPPORT
#define MIB_WLAN_LIFETIME						7008
#endif
#endif

#ifdef CONFIG_USER_CWMP_ISP_CUSTOMIZE_SUPPORT
#define MIB_NTP_SYNC_INTERVAL						7009
#endif

#ifdef CONFIG_CMCC
#define	MIB_WLAN_MANUAL_PRIORITY     7010
#endif

#ifdef CONFIG_FWD_UNIFIED_SUPPORT_PLUGIN
#ifdef CONFIG_RTL_JFFS2_FILE_PARTITION
#define PLUGIN_INST_DEF_PATH			"/jffs2/plugins"
#else
#define PLUGIN_INST_DEF_PATH			"/var/plugins"
#endif
#define PLUGIN_INSTALL_DIRNAME			"installed"		//DIR Fullpath: $PLUGIN_INST_DEF_PATH/$PLUGIN_INST_INFO_DIRNAME

#define MIB_PLUGIN_INST_PATH			7011
#endif

#ifdef CONFIG_APP_DHCPRELAY
#define MIB_DHCP_RELAY_SERVER_IP 7300
#define MIB_DHCP_RELAY_WAN_IDX    7301
#endif

#define MIB_SITE_ACCESS 7310

#ifdef CONFIG_APP_ADAPTER_API_ISP
#define MIB_DUT_TIMEING_RESTART_ENABLE	7320
#define MIB_DUT_TIMEING_RESTART_MODE	7321
#define MIB_DUT_TIMEING_RESTART_WDAY	7322
#define MIB_DUT_TIMEING_RESTART_HOUR	7323
#define MIB_DUT_TIMEING_RESTART_MINUTE	7324
#endif

#define SCRLOG_DISPLAY_CONFFILE			"/var/syslog.conf"
#ifdef CONFIG_RTL_JFFS2_FILE_PARTITION
#define SCRLOG_SAVED_FILENAME           "/jffs2/syslog.txt"
#else
#define SCRLOG_SAVED_FILENAME           "/var/syslog.txt"
#endif
...
#define WAN_INTERFACE_LAN_PORT_NUM MAX_PHY_PORT_NUM //The phy port customer board have (UI show)
#else
#define WAN_INTERFACE_LAN_PORT_NUM 4 //The phy port customer board have (UI show)
#endif

#define WAN_INTERFACE_EACH_WLAN_PORT_NUM (1+NUM_VWLAN+1) //the real wlan port (UI show), root + vap + vxd
#define WAN_INTERFACE_WLAN_PORT_NUM (WAN_INTERFACE_EACH_WLAN_PORT_NUM*NUM_WLAN_INTERFACE)
...
#ifdef CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT
#define ETH_IF_NUM (6+WANIFACE_NUM)  //eth0,2,3,4,5,1 eth1.1 ...
#else
#define ETH_IF_NUM (5+WANIFACE_NUM)  //eth0,2,3,4,1 eth1.1 ...
#endif
#define WLAN_IF_NUM (1+NUM_VWLAN+1+1+MAX_WDS_NUM)
//root+vap+vxd+mesh+wds+wlan-msh
#define ALL_IF_NUM (ETH_IF_NUM+(WLAN_IF_NUM)*(NUM_WLAN_INTERFACE)+1)

#ifdef CONFIG_APP_TR069
#define TOTAL_INTERFACE_PORT_NUM     (WAN_INTERFACE_LAN_PORT_NUM+WAN_INTERFACE_WLAN_PORT_NUM+1)  	//WAN_INTERFACE_LAN_PORT_NUM+WAN_INTERFACE_WLAN_PORT_NUM+1

#endif
#if 0
#define RTL_ETHWAN1_DEV_NAME "eth1"
#define RTL_ETHWAN2_DEV_NAME "eth8"
#define RTL_ETHWAN3_DEV_NAME "eth9"
#define RTL_ETHWAN4_DEV_NAME "eth10"
#define RTL_ETHWAN5_DEV_NAME "eth11"
#define RTL_ETHWAN6_DEV_NAME "eth12"
#define RTL_ETHWAN7_DEV_NAME "eth13"
#define RTL_ETHWAN8_DEV_NAME "eth14"

#define RTL_PPP1_DEV_NAME "ppp1"
#define RTL_PPP2_DEV_NAME "ppp8"
#define RTL_PPP3_DEV_NAME "ppp9"
#define RTL_PPP4_DEV_NAME "ppp10"
#define RTL_PPP5_DEV_NAME "ppp11"
#define RTL_PPP6_DEV_NAME "ppp12"
#define RTL_PPP7_DEV_NAME "ppp13"
#define RTL_PPP8_DEV_NAME "ppp14"
#endif
#define RTL_BR0_DEV_NAME "br0"
...
typedef enum IF_INDEX_
{
	...
	//wlan1 mesh and wds
	IF_MESH_IDX=IF_WLAN1_VXD_IDX+1+MAX_WDS_NUM+1,
...
{
	IP_PROTOCOL_MODE_IPV4=1,
	IP_PROTOCOL_MODE_IPV6=2,
	IP_PROTOCOL_MODE_BOTH=3
} IP_PROTOCOL_MODE_T;

typedef enum QueueID_
{
	NO_QUEUE=0,
	QUEUE1,
	QUEUE2,
...
#ifdef CONFIG_IPV6
#define DHCP6C_PREFIX_ENABLE 0x01
#define DHCP6C_ENABLE 0x02
#endif
#define X_CT_SRV_TR069		0x01
#define X_CT_SRV_INTERNET	0x02
#define X_CT_SRV_OTHER		0x04
#define X_CT_SRV_VOICE		0x08
#define X_CT_SRV_IPTV		0x10
#define X_CT_SRV_TR069_BRIDGE		0x20
#define X_CT_SRV_TR069_INTERNET		0x40
...
//#define CONFIG_ETHWAN				1 //define CONFIG_ETHWAN when there's multi-lan exist
#define BR_ROUTE_ONEPVC				1 //set bridge and route connection on one vlanid
#define _PRMT_USBRESTORE            	1
#else
#ifdef CONFIG_APP_TR069
#define TOTAL_INTERFACE_PORT_NUM     (4+10+1)  	//WAN_INTERFACE_LAN_PORT_NUM+WAN_INTERFACE_WLAN_PORT_NUM+1
...
#define RTL_LINK_MAX_EXTEND_OF_SN		94
#if defined(CONFIG_ELINKSDK_SUPPORT)
#define RTL_ELINKSDK_URL_LEN			256
#endif
#define RTL_LINK_INFO_LEN             512
#endif
#ifdef CONFIG_APP_WEAVE
...
#ifdef CONFIG_APP_PIMD
#define MAX_PIMD_IF_NUM			5
#define MAX_PIMD_RP_GROUP_NUM		10
#endif
#ifdef CONFIG_APP_MROUTED
#define MAX_MROUTED_IF_NUM			5
#define MAX_MROUTED_TUNNEL_NUM		5
#define MAX_MROUTED_ALTNET_NUM		30
#endif
...
//#define CONFIG_WPS_TRIGGER_SINGLE_INTERFACE
...
#define MAX_AWIFI_TRUSTED_MAC_NUM 10
#define MAX_AWIFI_TRUSTED_MAC_COMMENT 32

#define MAX_AWIFI_TRUSTED_URL_NUM 10
#define MAX_AWIFI_TRUSTED_URL_LEN 32
#define MAX_AWIFI_TRUSTED_URL_COMMENT 32
#endif

#ifdef __mips__
#define FLASH_WHOLE_FLASH_NAME	"wholeflash"
...
#define BACKUP_CURRENT_SETTING_SECTOR_LEN (CONFIG_RTL_CURRENT_SETTING_OFFSET-CONFIG_RTL_DEFAULT_SETTING_OFFSET)
#endif
#endif
...
#ifdef BLUETOOTH_HW_SETTING_SUPPORT
#define BACKUP_BLUETOOTH_HW_SETTING_OFFSET (BACKUP_HARDWARE_SETTING_OFFSET+0x1000)
...
#ifdef BACKUP_DEFAULT_SETTING_SUPPORT
#define CURRENT_SETTING_SECTOR_LEN (CONFIG_RTL_BACKUP_DEFAULT_SETTING_OFFSET-CONFIG_RTL_CURRENT_SETTING_OFFSET)
#else
#ifdef BACKUP_CURRENT_SETTING_SUPPORT
#define CURRENT_SETTING_SECTOR_LEN (CONFIG_RTL_BACKUP_CURRENT_SETTING_OFFSET-CONFIG_RTL_CURRENT_SETTING_OFFSET)
#else
#define CURRENT_SETTING_SECTOR_LEN (CONFIG_RTL_WEB_PAGES_OFFSET-CONFIG_RTL_CURRENT_SETTING_OFFSET)
#endif
#endif
...
#define SIOCGIWRTLSTAEXTRAINFO      0x8B40  // get station table information and extra info
...
#endif // VPN_SUPPORT
typedef enum { PROTO_BOTH=3, PROTO_TCP=1, PROTO_UDP=2, PROTO_ICMP=4} PROTO_TYPE_T; //support icmp
...
#define LANWAN_BINDING_PORTBASE		0
#define LANWAN_BINDING_VLANBASE		1

#define VLANBINDING_PAIR_DELIMITER	","
#define VLANBINDING_PAIR_MEMBER_DELIMITER	"/"

#define IP_VERSION4 4
#define IP_VERSION6 6
#define DEFAULT_UNTAG_WAN_VLANID	8

typedef struct vlanbinding_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ VLANBINDING_T, *VLANBINDING_Tp;
#endif
...
#undef MIBDEF
}__PACK__ QOSTYPE_T, *QOSTYPE_Tp;

// rule
typedef struct qosrule_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
// wan_port
#if defined(CONFIG_RTL_ISP_MULTI_PHY_WAN_SUPPORT)
typedef struct qoswanport_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ QOSWANPORT_T, *QOSWANPORT_Tp;
#endif

// app
typedef struct qosapp_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ QOSAPP_T, *QOSAPP_Tp;

typedef struct qoscar_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ QOSCAR_T, *QOSCAR_Tp;


typedef struct qoscar_iface_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ QOSCAR_IFACE_T, *QOSCAR_IFACE_Tp;

typedef struct qoscar_vlan_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ QOSCAR_VLAN_T, *QOSCAR_VLAN_Tp;

typedef struct qoscar_ip_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ QOSCAR_IP_T, *QOSCAR_IP_Tp;

#if defined(CONFIG_MAC_SHAPING_QOS)
typedef struct qoscar_mac_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ QOSCAR_MAC_T, *QOSCAR_MAC_Tp;
#endif
...
#ifdef CONFIG_APP_MMELINKSERVER
#define MAX_MME_STR_LEN 255
#define MAX_MME_WAN_NUM 5

typedef struct aliasNameMapping
{
     char  aliasIfName[MAX_MME_STR_LEN];
     char  realIfName[32];
	 unsigned char isMapped;
     unsigned char serviceType;
}__PACK__ aliasNameMapping_t, *aliasNameMapping_Tp;
...
#ifdef CONFIG_APP_PIMD
typedef struct pimd_rp_group_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ PIMD_RP_GROUP_T, *PIMD_RP_GROUP_Tp;
typedef struct pimd_if_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ PIMD_IF_T, *PIMD_IF_Tp;
#endif

#ifdef CONFIG_APP_MROUTED
typedef struct mrouted_if_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ MROUTED_IF_T, *MROUTED_IF_Tp;
typedef struct mrouted_tunnel_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ MROUTED_TUNNEL_T, *MROUTED_TUNNEL_Tp;

typedef struct mrouted_altnet_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ MROUTED_ALTNET_T, *MROUTED_ALTNET_Tp;
#endif
...
#ifdef CHECK_IPV6_DHCP_OPTION
typedef struct dhcp6_option16_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ DHCP6_OPTION16_T, *DHCP6_OPTION16_Tp;
typedef struct dhcp6_option17_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ DHCP6_OPTION17_T, *DHCP6_OPTION17_Tp;
#endif

//for X_CT-COM_DHCPOPTION60 and X_CT-COM_DHCPOPTION125
typedef struct x_ct_com_dhcp_option {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ X_CT_COM_DHCP_OPTION_T, *X_CT_COM_DHCP_OPTION_Tp;

#ifdef CONFIG_APP_AWIFI_SUPPORT
typedef struct awifi_trusted_mac_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ AWIFI_TRUSTED_MAC_T, *AWIFI_TRUSTED_MAC_Tp;

typedef struct awifi_trusted_url_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ AWIFI_TRUSTED_URL_T, *AWIFI_TRUSTED_URL_Tp;
#endif
...
#define MAX_RTL_FW_TBL_RULES    30
#define MAX_RTL_FW_TBL_RULE_LEN 130
//----
#define RTL_MIB_ID				 3600
#define MIB_RTL_FW_NUM 		 RTL_MIB_ID + 1
#define MIB_RTL_FW_TBL		 ((MIB_RTL_FW_NUM+1)|MIB_TABLE_LIST)
#define MIB_RTL_FW_ADD		 ((MIB_RTL_FW_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_RTL_FW_DEL		 ((MIB_RTL_FW_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_RTL_FW_DELALL  ((MIB_RTL_FW_NUM+4)|MIB_DELALL_TBL_ENTRY)
#define MIB_RTL_FW_RULE 	  3606

#define MIB_RTL_CMT_CLOUD_MANAGED 	 3610

typedef struct rtl_fw_tbl_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	  _ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ RTL_FW_TBL_T, *RTL_FW_TBL_Tp;
#endif
// ------------------------ RTL CODE - END ------------------------
...
#ifdef CONFIG_FWD_UNIFIED_SUPPORT_PLUGIN
#define PLUGIN_SIGNATURE			"plug"
#define PLUGIN_HDR_NAME_LEN			16
typedef struct plugin_header {
	unsigned char 	signature[SIGNATURE_LEN];
	unsigned char	name[PLUGIN_HDR_NAME_LEN];
	unsigned int 	len;	//padding only(exclude cksum length)
	unsigned short 	padding;
	unsigned short 	cksum;	//MUST keep it the last field for validate cksum
}__PACK__ PLUGIN_HEADER_T, *PLUGIN_HEADER_Tp;
#endif
...
typedef enum { 
		...
		case TUNNELX_CT_COM_DHCP_OPTION_T6_T:
#endif 
#endif 
	...
	DHCPRSVDIP_ARRY_T,	
...
#ifdef CHECK_IPV6_DHCP_OPTION
		DHCP6_OPTION16_ARRAY_T,
		DHCP6_OPTION17_ARRAY_T,
#endif
#if defined(_PRMT_X_TELEFONICA_ES_DHCPOPTION_)
...
#ifdef CONFIG_APP_TR069
		X_CT_COM_DHCP_OPTION60_ARRAY_T,
		X_CT_COM_DHCP_OPTION125_ARRAY_T,
#endif 
...
#endif
#ifdef CONFIG_APP_PIMD
		PIMD_RP_GROUP_ARRAY_T,
		PIMD_IF_ARRAY_T,
#endif
#ifdef CONFIG_APP_MROUTED
		MROUTED_IF_ARRAY_T,
		MROUTED_IF_TUNNEL_ARRAY_T,
		MROUTED_IF_ALTNET_ARRAY_T,
#endif
#ifdef VPN_SUPPORT
		IPSECTUNNEL_ARRAY_T,
#endif
		...
		QOS_APP_ARRAY_T,
		QOS_CAR_ARRAY_T,
		QOS_CAR_IFACE_ARRAY_T,
		QOS_CAR_VLAN_ARRAY_T,
		QOS_CAR_IP_ARRAY_T,
	#if defined(CONFIG_MAC_SHAPING_QOS)
		QOS_CAR_MAC_ARRAY_T,
	#endif
...
#ifdef CONFIG_APP_AWIFI_SUPPORT
	AWIFI_TRUSTED_MAC_ARRAY_T,
	AWIFI_TRUSTED_URL_ARRAY_T,
#endif
...
extern unsigned int val_RTL_LOCK_ALREADY_TAKEN;
#endif

#include <sys/time.h>
#include <time.h>
#define RTL_TIME_CODE 					\
	struct timeval tp;								\
	struct tm *now;								\
	struct tm  now2;								\
													\
	...
	gettimeofday(&tp, 0); 							\
	/*The return value points to a statically... */			\
	now = gmtime((time_t *)&tp.tv_sec);			\
	if(!now)										\
	{												\
		now = &now2; /* avoid crash */				\
	}

#define RTL_TIME_FORMAT     "%4d/%02d/%02d|%02d:%02d:%02d.%03ld|"
#define RTL_TIME_FMT_FILE   "%4d%02d%02d-%02d%02d%02d.%03ld"
#define RTL_TIME_PARAMS     now->tm_year + 1900, now ->tm_mon + 1, now->tm_mday, now->tm_hour, now->tm_min, now->tm_sec, tp.tv_usec / 1000

// for sure
#define RTL_LOG_CALLER__SYS 0
#define RTL_LOG_CALLER__SS  1
#define RTL_LOG_CALLER__SM  2
#define RTL_LOG_CALLER__AP  3
#define RTL_LOG_CALLER__DBG 4
#define RTL_LOG_CALLER__LIST  5

extern char * RTL_LOG_CALLER[];

#define _RTL_LOG(prefix, fmt, ...)                                                       \
	do {                                                                                     \
		RTL_TIME_CODE                                                                        \
		fprintf(stdout, RTL_TIME_FORMAT "%05d|%s|| " fmt "\n", RTL_TIME_PARAMS, __LINE__, RTL_LOG_CALLER[prefix],  ##__VA_ARGS__);         \
	} while(0);

#define RTL_LOG_DBG_A(fmt, ...)   _RTL_LOG(RTL_LOG_CALLER__AP, fmt , ##__VA_ARGS__);
#endif
// ------------------------ RTL CODE - END ------------------------
...
#ifdef BACKUP_HARDWARE_SETTING_SUPPORT
#define BACKUP_HWCONF_SHM_KEY	9


#ifdef BLUETOOTH_HW_SETTING_SUPPORT
#define BACKUP_BLUETOOTH_HW_SHM_KEY 7
#endif



#ifdef CUSTOMER_HW_SETTING_SUPPORT
#define BACKUP_CUSTOMER_HW_SHM_KEY 8
#endif

#endif 

#ifdef RF_DPK_SETTING_SUPPORT
#define RF_DPK_SHM_KEY 10
#endif /* RF_DPK_SETTING_SUPPORT */
...
typedef enum 
{
...
#ifdef CONFIG_SNMP
	DECISION_LAN_SNMP_FUNC_ID,
#endif
	DECISION_LAN_MAC_FUNC_ID,
#ifdef CONFIG_IPV6
	DECISION_IPV6_LAN_FUNC_ID,
#endif
	DECISION_VLAN_FUNC_ID,
	DECISION_NTP_ENABLE_FUNC_ID,
	DECISION_DDNS_ENABLE_FUNC_ID,
#if defined(CONFIG_APP_TR069)	
    // TR069 on/off affects firewall/qos, so must use decision function
    DECISION_TR069_ENABLE_FUNC_ID,
#endif
	...
	DECISION_WLAN_IFACE_CHANGE_ID,
#ifdef WLAN_PROFILE
	DECISION_WLAN_PROFILE_FUNC_ID,
#endif
	DECISION_WLAN_BLOCK_RELAY_ID,
	DECISION_WAN_RESTART_ID,
	DECISION_ALL_WAN_RESTART_ID,
#ifdef RTK_MULTI_AP
	DECISION_MULTI_AP_FUNC_ID,
#endif
	DECISION_IPV6_WAN_RESTART_ID,
	DECISION_IPV6_ALL_WAN_RESTART_ID,
		/*...*/
...
//lan app
	REINIT_LAN_APP_BEGIN=500,
	REINIT_LAN_APP_DHCP_FUNC_ID,
#ifdef CONFIG_IPV6
	REINIT_IPV6_LAN_APP_RADVD_FUNC_ID,
	REINIT_IPV6_LAN_APP_DHCP6S_FUNC_ID,
#endif
#ifdef CONFIG_SNMP	
	REINIT_LAN_SNMP_FUNC_ID,
#endif
#ifdef CONFIG_APP_VSFTPD
	REINIT_LAN_FTPD_FUNC_ID,
#endif
#ifdef CONFIG_APP_TELNETD
	REINIT_LAN_TELNETD_FUNC_ID,
#endif
#ifdef CONFIG_APP_DROPBEAR_SSH
	REINIT_LAN_SSH_FUNC_ID,
#endif
	INIT_MISC_FUNC_ID,
...
//wan
	REINIT_WAN_CLEAN_FUNC_ID=700,
	REINIT_WAN_START_FUNC_ID,
#ifdef CONFIG_IPV6
	REINIT_IPV6_WAN_CLEAN_FUNC_ID,
	REINIT_IPV6_WAN_START_FUNC_ID,
#endif
#if defined(CONFIG_APP_TR069)	
	REINIT_WANAPP_TR069_FUNC_ID,
#endif
#ifdef DOS_SUPPORT
	REINIT_WAN_DOS_FUNC_ID,
#endif
	REINIT_WANAPP_NTP_FUNC_ID,
	REINIT_WANAPP_DDNS_FUNC_ID,
#ifdef CONFIG_CMCC
	REINIT_WANAPP_UPNP_FUNC_ID,
#endif
#ifdef CONFIG_APP_AWIFI_SUPPORT
	REINIT_WANAPP_AWIFI_FUNC_ID,
#endif

	REINIT_WAN_FINISH_FUNC_ID,
	REINIT_WAN_END,

//firewall
	REINIT_FIREWALL_BEGIN=800,
	REINIT_FIREWALL_DMZ_ID,
	REINIT_FIREWALL_PORTFORWARD_ID,
	REINIT_FIREWALL_PASSTHROUGH_ID,
	...
	REINIT_FIREWALL_SUPERACCESS_ID,
#if defined(CONFIG_RTL_ACCESS_INTERNET_USER_NUM_LIMIT)
		REINIT_INTERNET_USER_LIMIT_ID,
#endif

#if defined(MULTI_WAN_QOS) || defined(CONFIG_CMCC_QOS)
	REINIT_FIREWALL_QOS_ID,
#endif
#if defined(CONFIG_APP_PIMD) || defined(CONFIG_APP_RTL_QUAGGA)|| defined(CONFIG_APP_MROUTED)|| defined(ROUTE_SUPPORT)
	REINIT_DYNAMIC_ROUTE_ID,
#endif
#ifdef CONFIG_SNMP
	REINIT_FIREWALL_SNMP_ID,
#endif
#ifdef CONFIG_APP_TR069
	REINIT_FIREWALL_TR069_ID,
#endif
#ifdef CONFIG_IPV6
	REINIT_IPV6_FIREWALL_FUNC_ID,
#endif
	REINIT_STAITC_ROUTE_ID,
#if defined(CONFIG_ANDLINK_SUPPORT) || defined(CONFIG_ELINK_SUPPORT)
    REINIT_FIREWALL_ANDLINK_ID,
    REINIT_RTL_LINK_ID,
#endif

#if defined(CONFIG_MULTIPLE_WAN_VLAN_BINDING)
	REINIT_VLAN_BINDING_ID,
#endif
...
typedef struct WAN_DATA_MODULE_{ //all string
	unsigned char virtual_wan_iface[32];//ppp8	
	unsigned char wan_iface[32];//"eth8.200"
	unsigned char real_iface[32];//"eth8"
	...
	unsigned char dns_addr[60];
	unsigned int  wan_type;
    int app_type;
#ifdef CONFIG_IPV6
	unsigned char ipv6Enable;
	unsigned char ipv6_addr[INET6_ADDRSTRLEN];
	int addr_prefix_len;
	unsigned char ipv6_gw[INET6_ADDRSTRLEN];
	int gw_prefix_len;
	unsigned char ipv6_dns1[INET6_ADDRSTRLEN];
	int dns1_prefix_len;
	unsigned char ipv6_dns2[INET6_ADDRSTRLEN];
	int dns2_prefix_len;
	unsigned char ipv6_dns3[INET6_ADDRSTRLEN];
	int dns3_prefix_len;
	char action[8];
	unsigned char dev_iface[NAMSIZE];
#ifdef CONFIG_DSLITE_SUPPORT
	char aftr_name[MAX_DOMAIN_LEN];
#endif
#endif
...
int getWanIfIdexViaIfname(char* ifname);
#endif
...
struct port_root_iface_mapping
{
	int port_id;
	char *root_ifname;
};
...
#if defined(CONFIG_CMCC) || defined(CONFIG_USER_CWMP_WHTH_TR098_CTCOM)
#define CUSTOMIZE_SSID				1
#define CUSTOMIZE_SSID_GW			1
//#define CUSTOMIZE_SSID_AP_RPT		1
//#define CUSTOMIZE_SSID_GUEST		1
#define SYNC_VXD_TO_ROOT			1

#ifdef CONFIG_USER_CWMP_WHTH_TR098_CTCOM // need to be changed CT-COM
#ifdef CUSTOMIZE_SSID_GW
#define CUSTOMIZE_SSID_PREFIX_GW_2G		"ChinaNet-2.4G-"
#define CUSTOMIZE_SSID_PREFIX_GW_5G		"ChinaNet-5G-"
#define	CUSTOMIZE_SSID_GUEST_SUFFIX		"-Guest"
#endif

#elif defined(CONFIG_CMCC)
#ifdef CUSTOMIZE_SSID_GW
#define CUSTOMIZE_SSID_PREFIX_GW_2G		"CMCC_2.4G_"
#define CUSTOMIZE_SSID_PREFIX_GW_5G		"CMCC_5G_"
#define	CUSTOMIZE_SSID_GUEST_SUFFIX		"-Guest"
#endif

#if defined(CUSTOMIZE_SSID_AP_RPT)
#define CUSTOMIZE_SSID_PREFIX_AP_2G		"CMCC-2.4G-"
#define CUSTOMIZE_SSID_PREFIX_AP_5G		"CMCC-5G-"
#define CUSTOMIZE_SSID_RANDOM_CHAR_NUM	4
#endif
#endif
#endif
