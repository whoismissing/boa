...
function on_init()
{
	with ( document.forms[0] ) 
	{
		connType[connTypeIdx].checked = true;
		
		wanname.value = wanName;
...
<div align="left" style="padding-left:20px; padding-top:5px">
	...
	<form action=/boafrm/formFastConf method=POST name="formfastconf">
		...
		<table cellpadding="0px" cellspacing="2px">
			<tr nowrap>
				<td width="150px">连接名称：</td>
				<td><input type="text" name="wanname" size="32" maxlength="32" value="" readonly="true"></td>
			</tr>
		</table>
		...
		<input type="hidden" value="/net_eth_links_cmcc.htm" name="submit-url">
	</form>
</div>
</blockquote>
</body>
