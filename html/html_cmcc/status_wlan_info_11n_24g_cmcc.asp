...
var rcs = new Array();
rcs.push(new it_nr("0", new it("ifname", "无线"), new it("rx_packets", 17), new it("rx_bytes", 1670), new it("rx_errors", 0), new it("rx_dropped", 0), new it("tx_packets", 0), new it("tx_bytes", 0), new it("tx_errors", 0), new it("tx_dropped", 730)));
...
wlDefChannel[0]=9;
Band2G5GSupport[0]=1;
wlan_parm.push(new it_nr("0", new it("ssid", "0"), new it("ssid_idx", 1), new it("hiddenssid", 0), new it("band", 11), new it("disabled", 0), new it("bssid", "00:e0:4c:86:70:01"), new it("encrypt_state", 1), new it("auth_mode", "WPA-PSK/WPA2-PSK"), new it("encrypt_mode", "TKIP+AES")));
