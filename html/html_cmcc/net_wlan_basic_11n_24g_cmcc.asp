...
//	var channelbound_str = document.wlanSetup.chanwid.options[channelbound_idx].value;
	...
	if(channelbound_idx > (idx-1))
		...
		document.wlanSetup.chanwid.selectedIndex = _chanwid[ssid_idx_now];	
...
<option value=10>2.4 GHz (B+G+N)</option>
	...
	<table border="0" cellpadding="4" cellspacing="0" width="400">
		...
		<tr id="SpeedIDup"> 
			<td width="45%">速率:</td>
			<td colspan="2"><select style="width: 180px" size="1" name="txRateUp">
				<!--<SCRIPT>
					get_rate(txrate);
				</SCRIPT> -->
			</select></td> 
...
<option value="both">open+share</option>
	...
	<br><br>
			<input type="hidden" value="/net_wlan_basic_11n_24g_cmcc.asp" name="submit-url">
