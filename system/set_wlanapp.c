...
//for mesh========================================================
    ...
    do{
        ...
        if(isFileExist("/var/run/wscd-wlan1.pid"))
        {
        ...
        if(isFileExist("/var/run/wscd-wlan0-vxd.pid"))
        {
        ...
        if(isFileExist("/var/run/wscd-wlan1-vxd.pid"))
        {
        ...
        if(isFileExist("/var/run/wscd-wlan0-wlan1.pid"))
        {
        ...
        if(isFileExist("/var/run/wscd-wlan0-wlan1-c.pid"))
        {
